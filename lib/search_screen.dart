...
class _SearchScreenState extends State<SearchScreen> {
          ...
          child: Column(
           ...
           Container(
             ...
             child: Row(
              ...
              //List Tile For Predictions of Related Locations.
  ...
  void findPlace(String placeName) async{
    if(placeName.length>1){
      ...
      String autocompleteurl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=AIzaSyDVHfnBiF57K1ZUqP2wImN5zE95Ue2ZALI&components=country:in";
...
class PredictionTile extends StatelessWidget{
  ...
  void getPlaceAddressDetails(String placeid, context) async{
    ...
    String placeDetailsurl = "https://maps.googleapis.com/maps/api/place/details/json?&place_id=$placeid&key=AIzaSyDVHfnBiF57K1ZUqP2wImN5zE95Ue2ZALI";
    ...
    if(res["status"]=="OK"){
      ...
      Address userdropOffAddress =Address(
          ...
          st1,                                               // placeName
          st2,                                              // placeId
          res["result"]["geometry"]["location"]["lat"],     // longitude
